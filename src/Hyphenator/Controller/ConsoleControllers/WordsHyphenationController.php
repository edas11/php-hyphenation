...
use Edvardas\Hyphenation\Hyphenator\ModelAction\WordsHyphenationModelAction;
...
class WordsHyphenationController implements Controller
{
    ...
    public function handleRequest(): void
    {
        ...
        $action = new WordsHyphenationModelAction($modelInput, $this->output, $this->modelFactory, $this->logger);
        $action->execute();
    }
}