...
class HyphenationConsoleDataProvider implements HyphenationDataProvider
{
    ...
    {
        $choice = $this->getActionInput();
        switch ($choice) {
            case self::HYPHENATE_ACTION:
                return $this->getHyphenationAction();
                break;
            case self::PUT_PATTERNS_IN_DB_ACTION:
    ...
    private function getActionInput(): int
    {
    ...
    private function getSourceInput(): int
    {
